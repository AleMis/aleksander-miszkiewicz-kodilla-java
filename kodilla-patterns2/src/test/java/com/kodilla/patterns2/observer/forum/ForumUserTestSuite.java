...
public class ForumUserTestSuite {
    ...
    public void testUpdate() {
        ...
        javaHelpForum.registerObservator(johnSmith);
        javaHelpForum.registerObservator(jessiePinkman);
        javaToolsForum.registerObservator(ivoneEscobar);
        javaToolsForum.registerObservator(jessiePinkman);
